...
After five rounds of placement and critique, iteration 6 was the best layout. Placement applied the upper-rack correction from iteration 5 — the rack sits further back in the cavity, matching the source photo more closely. Cabinet, door, and lower rack stayed locked.
